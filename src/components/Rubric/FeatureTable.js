                  ...
                  <ul>
                      ...
                      <ul>
                        <li>
                          <div className="descLongDiv">
                            ...
                            organized in coherent packages, folders, files, etc.
                          </div>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <div className="descLongDiv">
                            The visibility of methods/fields is not well thought
                            out (fields should usually be private).
                          </div>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <div className="descLongDiv">
                            Most of the classes and functions perform a limited
                            set of tasks and their bodies are limited in length.
                          </div>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          <div className="descLongDiv">
                            Manually casting types unnecessarily. E.g., (Object)
                            "Hello World!".
                          </div>
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li>
                          <div className="descLongDiv">
                            ...
                            meaning and/or derived values are hard-coded (magic
                            numbers).
                          </div>
                        </li>
                      </ul>
